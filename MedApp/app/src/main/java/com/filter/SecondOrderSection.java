...
public class SecondOrderSection {
	...
	/**
	 * States required to support processing of a continuous data stream in
	 * consecutive, contiguous blocks.
	 */
	double s1, s2;

	/**
	 * Instantiates a new second order section, with values for the numerator
	 ...
	 * @param b2
	 *            Numerator coefficient b[2].
	 * @param a1
	 *            Denominator coefficient a[1].
	 * @param a2
	 *            Denominator coefficient a[2].
	 */
	public SecondOrderSection(double b0, double b1, double b2, double a1,
			double a2) {
	 ...
	 * 
	 * @param x
	 *            double containing value of the single input sample.
	 ...
	 * 
	 * @param x
	 *            double[] containing the sequence of input samples.
	 * @param y
	 *            double[] containing the filtered result. May be the same array
	 *            as x.
	 */
	 ...
	 * 
	 * @param ps
	 *            PrintStream to which the filter coefficients and states are
	 *            printed.
	 */
